...
const DEFAULTS: SiteConfig = {
  ...
  clinic_slogan: 'Tu veterinaria de confianza. Cuidamos a tu mascota como si fuera nuestra.',
  hero_title: 'Tu mascota merece el mejor cuidado',
  hero_subtitle: 'Somos una veterinaria con anos de experiencia brindando atencion profesional y amorosa. Cuidamos a tu mascota como si fuera nuestra.',
  cta_title: 'Tu mascota necesita atencion?',
  cta_subtitle: 'Reserva un turno online o contactanos por WhatsApp. Estamos para ayudarte.',
